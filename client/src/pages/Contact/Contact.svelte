...
<div class="flex mt-8">
    <div class="w-1/3 flex-none mr-8">
        <Img src={waltz} alt="Waltz ringing" class="shadow-md drop-shadow-md rounded-sm" />
    </div>
    <div class="flex-auto w-64 flex flex-col items-center">
        ...
        <P weight="light" class="text-slate-950 mb-12">
            ...
            the globe. <br /><br /> If you have a minute, we would love to hear how we
            can improve our service even further for CineMatch and all of our users.
            You can get in touch with us through our site, email or socials. We commit
            to being responsive in our listening of your feedback and working hard
            to input that feedback into the continued development of this effort. <br /><br />
        ...
        <div class="w-full flex flex-col items-stretch">
            <form class="space-y-4" on:submit={handleContact} novalidate>
                <Label class="space-y-2">
                    <span>Your name</span>
                    <Input type="text" name="name" id="name" placeholder="Your name" bind:value={name} required />
                    {#if errors.name}
                ...
                <Label class="space-y-2">
                    ...
                    <Input type="email" name="email" id="email" placeholder="Your email" bind:value={email} required />
                    {#if errors.email}
                ...
                <Label class="space-y-2">
                    ...
                    <Textarea name="message" id="message" placeholder="Your message" bind:value={message} required />
                    {#if errors.message}
