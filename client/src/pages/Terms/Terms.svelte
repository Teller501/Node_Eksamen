    ...
    <div class="w-1/4">
        <Sidebar>
            <SidebarWrapper class="shadow-sm border-2 border-slate-200">
                <SidebarGroup>
                    <SidebarItem label="Terms of Use" on:click={(event) => setActiveSection('terms', event)}>
                    </SidebarItem>
                    <SidebarItem label="Data Protection Policy" on:click={(event) => setActiveSection('data-protection', event)}>
                    </SidebarItem>
                </SidebarGroup>
            </SidebarWrapper>
        </Sidebar>
