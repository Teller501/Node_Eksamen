...
{#if active}
    <h1 class="text-slate-950">Terms of Use</h1>

    <p class="text-slate-950">Version 1.0</p>

    <p class="text-slate-950">
        The CineMatch website located at https://www.andersteller.dk is a
        copyrighted work belonging to CineMatch. Certain features of the Site
    ...
    <p class="text-slate-950">
        ...
        of the <a href="https://www.termsofusegenerator.net"
            >Terms Of Use Generator</a
        >.
    </p>

    <h2 class="text-slate-950 font-bold text-xl mt-8">Access to the Site</h2>
    ...
    <p class="text-slate-950">
        <strong>No Support or Maintenance.</strong> You agree that Company will have
    ...
    <h2 class="text-slate-950 font-bold text-xl mt-8">User Content</h2>
    ...
    <p class="text-slate-950">
        ...
        to liability. Company is not obliged to backup any User Content that you
        post; also, your User Content may be deleted at any time without prior notice
        to you. You are solely responsible for making your own backup copies of your
    ...
    <p class="text-slate-950">
        ...
        transmit, display, or distribute any User Content (i) that violates any third-party
        right or any intellectual property or proprietary right; (ii) that is unlawful,
        ...
        pornographic, obscene, patently offensive, promotes racism, bigotry, hatred,
        or physical harm of any kind against any group or individual; (iii) that
    ...
    <p class="text-slate-950">
        ...
        Such Third-Party Links & Ads are not under the control of Company, and Company
        ...
        in doing so. When you click on any of the Third-Party Links & Ads, the applicable
        third party's terms and policies apply, including the third party's privacy
    ...
    <h2 class="text-slate-950 font-bold text-xl mt-8">Disclaimers</h2>
    ...
    <p class="text-slate-950">
        <strong>Term and Termination.</strong> Subject to this Section, these Terms
        will remain in full force and effect while you use the Site.  We may suspend
        or terminate your rights to use the Site at any time for any reason at our
    ...
    <h2 class="text-slate-950 font-bold text-xl mt-8">Copyright Policy</h2>
    ...
    <List list="none" class="text-slate-950">
    ...
    <h2 class="text-slate-950 font-bold text-xl mt-8">General</h2>
    ...
    <p class="text-slate-950">
        <strong>Applicability of Arbitration Agreement.</strong> All claims and disputes
        in connection with the Terms or the use of any product or service provided
        by the Company that cannot be resolved informally or in small claims court
        shall be resolved by binding arbitration on an individual basis under the
        terms of this Arbitration Agreement.  Unless otherwise agreed to, all arbitration
    ...
    <p class="text-slate-950">
        <strong>Notice Requirement and Informal Dispute Resolution.</strong> Before
        either party may seek arbitration, the party must first send to the other
        party a written Notice of Dispute describing the nature and basis of the
        claim or dispute, and the requested relief.  A Notice to the Company should
        be sent to: CineMatch. After the Notice is received, you and the Company
        ...
        is received, either party may begin an arbitration proceeding.  The amount
    ...
    <p class="text-slate-950">
        ...
        Thousand U.S. Dollars (US $10,000.00) or more, the right to a hearing will
        ...
        States, and unless the parties agree otherwise.  If you reside outside of
        the U.S., the arbitrator shall give the parties reasonable notice of the
        date, time and place of any oral hearings. Any judgment on the award rendered
    ...
    <p class="text-slate-950">
        ...
        OR A JURY, instead electing that all claims and disputes shall be resolved
    ...
    <p class="text-slate-950">
        ...
        of more than one customer or user cannot be arbitrated or litigated jointly
    ...
    <p class="text-slate-950">
        ...
        shall be strictly confidential.  The parties agree to maintain confidentiality
    ...
    <p class="text-slate-950">
        <strong>Severability.</strong> If any part or parts of this Arbitration Agreement
    ...
    <p class="text-slate-950">
        <strong>Survival of Agreement.</strong> This Arbitration Agreement will survive
    ...
    <p class="text-slate-950">
        ...
        in order to maintain the status quo pending arbitration.  A request for interim
    ...
    <p class="text-slate-950">
        ...
        the personal jurisdiction of the courts located within dk County,
    ...
    <p class="text-slate-950">
        ...
        email. For contractual purposes, you (a) consent to receive communications
    ...
    <p class="text-slate-950">
        ...
        or enforce any right or provision of these Terms shall not operate as a waiver
        of such right or provision. The section titles in these Terms are for convenience
    ...
    <h2 class="text-slate-950 font-bold text-xl mt-8">Contact Information</h2>

    <p class="text-slate-950">Address: CineMatch</p>
    <p class="text-slate-950">Email: anders.teller@gmail.com</p>
{/if}
