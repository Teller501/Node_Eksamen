<script>
    ...
    import { ClockOutline, EyeOutline, EditSolid, StarSolid } from "flowbite-svelte-icons";
			...
			<div class="flex flex-col items-center space-x-2 mt-2 w-full">
				{#if stats}
					<List list="none" class="flex flex-col items-center w-full">
						<Li class="text-slate-950 font-light">Total movies watched: {stats.total_movies_watched}</Li>
						<Li class="text-slate-950 font-light">Movies watched this year: {stats.movies_watched_this_year}</Li>
						<Li class="text-slate-950 font-light">Most movies in a month: {stats.most_movies_in_a_month}</Li>
						<Li class="text-slate-950 font-light">Most movies in a day: {stats.most_movies_in_a_day}</Li>
						...
						<Li class="text-slate-950 font-light">Most watched genre: {stats.most_watched_genre}</Li>                  
					</List>
				{/if}
			</div>
		</div>		
