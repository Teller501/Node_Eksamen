...
router.get(
    "/api/logs/movie/:movie_id/aggregated",
    authenticateToken,
    async (req, res, next) => {
        const movieId = req.params.movie_id;
        ...
        try {
            ...
            res.json({
                ...
                pagination: {
                    ...
                    next_page:
                        offset + limit < totalReviews ? currentPage + 1 : null,
                ...
                const formattedResponse = {
                    data: {
                        unique_movies_watched:
                            result.rows[0].unique_movies_watched,
